...
config_rancher_helm_chart_version = '2.4.5' # see https://github.com/rancher/rancher/releases
config_rancher_cli_version = 'v2.4.5' # see https://github.com/rancher/cli/releases
...
config_helm_version = 'v3.2.4' # see https://github.com/helm/helm/releases
