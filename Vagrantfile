...
config_rancher_helm_chart_version = '2.5.1' # see https://github.com/rancher/rancher/releases
...
config_k8s_version = 'v1.19.2-rancher1-1' # see https://github.com/rancher/kontainer-driver-metadata/blob/release-v2.5/rke/k8s_rke_system_images.go of the version that ships with your rke version.
config_kubectl_version = '1.19.2-00' # NB execute apt-cache madison kubectl to known the available versions.
