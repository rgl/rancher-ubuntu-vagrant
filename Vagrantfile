...
config_rancher_helm_chart_version = '2.3.5' # see https://github.com/rancher/rancher/releases
...
config_rke_version = 'v1.0.4' # see https://github.com/rancher/rke/releases
config_k8s_version = 'v1.17.2-rancher1-2' # see https://github.com/rancher/kontainer-driver-metadata/blob/master/rke/k8s_rke_system_images.go of the version that ships with your rke version.
config_kubectl_version = '1.17.0-00' # NB execute apt-cache madison kubectl to known the available versions.
config_krew_version = 'v0.3.4' # see https://github.com/kubernetes-sigs/krew/releases
config_helm_version = 'v3.1.2' # see https://github.com/helm/helm/releases
