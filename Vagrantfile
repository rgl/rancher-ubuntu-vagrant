...
config_rancher_helm_chart_version = '2.4.8' # see https://github.com/rancher/rancher/releases
config_rancher_cli_version = 'v2.4.6' # see https://github.com/rancher/cli/releases
...
config_rke_version = 'v1.2.0' # see https://github.com/rancher/rke/releases
config_k8s_version = 'v1.18.8-rancher1-1' # see https://github.com/rancher/kontainer-driver-metadata/commits/release-v2.4/rke/k8s_rke_system_images.go of the version that ships with your rke version.
config_kubectl_version = '1.18.8-00' # NB execute apt-cache madison kubectl to known the available versions.
config_krew_version = 'v0.4.0' # see https://github.com/kubernetes-sigs/krew/releases
config_helm_version = 'v3.3.4' # see https://github.com/helm/helm/releases
config_metallb_helm_chart_version = '0.1.24' # see https://github.com/bitnami/charts/blob/master/bitnami/metallb/Chart.yaml
