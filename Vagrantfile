...
config_rancher_helm_chart_version = '2.6.0' # see https://github.com/rancher/rancher/releases
...
config_rke_version = 'v1.3.0'             # see https://github.com/rancher/rke/releases
config_k8s_version = 'v1.21.4-rancher1-1' # see the supported versions at https://github.com/rancher/rke/releases
